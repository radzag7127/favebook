...
const FacebookDesk: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Versi untuk layar di atas 900px */}
      <div className="hidden lg:flex flex-col lg:flex-row lg:space-x-6 lg:items-start mt-[-9vh]">
        <div
          className="flex flex-col items-center mt-14 lg:items-start lg:mb-0 lg:ml-4"
        ...
        >
          ...
          />
          <h2
            className="text-center lg:text-left text-gray-700 font-medium"
        ...
        <div className="flex flex-col items-center">
          <div
            className="bg-white p-6 rounded-lg shadow-lg text-center max-w-md ml-12 text-md"
            style={{ height: "46vh", width: "54vh" }}
          >
          ...
          <div
            className="mt-8 text-center ml-12"
